...
const std::string test_file = "./units_test.txt";

TEST_CASE("operator +") {
    ifstream units_file{test_file};
    NumberWithUnits::read_units(units_file);
    NumberWithUnits a = NumberWithUnits(1,"kg")+NumberWithUnits(1,"kg");
...
TEST_CASE("operator >>") {
    ...
    str >> a;
    CHECK(str.str()=="700[ ton ]");
    istringstream str2("700 [ bllaalla ]");
    ostringstream temp;
    temp << a;
    CHECK_THROWS(str2 >> a);
    CHECK(temp.str()=="700[ton]");
}
